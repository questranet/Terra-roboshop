module "vpc" {
  source                 = "git::https://github.com/questranet/tf-module-vpc.git"
...
module "mysql" {
  source                 = "git::https://github.com/questranet/tf-module-rds.git"
  component              = "mysql"
  env                    = var.env
...
module "docdb" {
  source                 = "git::https://github.com/questranet/tf-module-docdb.git"
  component              = "docdb"
  env                    = var.env
  subnets                = module.vpc.db_subnets
  vpc_cidr               = var.vpc_cidr
...
module "elasticache" {
  source                  = "git::https://github.com/questranet/tf-module-elasticache.git"
...
module "rabbitmq" {
  source = "git::https://github.com/questranet/tf-module-rabbitmq.git"
  component              = "rabbitmq"
  env                    = var.env
  subnets                = module.vpc.db_subnets
  vpc_cidr               = var.vpc_cidr
...
module "ms-components" {
  ...
  source = "git::https://github.com/questranet/tf-module-app.git"
...
module "alb" {
  source                 = "git::https://github.com/questranet/tf-module-alb.git"
  for_each               = var.alb
